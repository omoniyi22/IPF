...
const Question = () => (
  <div className="real_question border">
    <div className="my_que border  pnt p-2 z-balm">
      <div className="head border flex">
        <div className="border flex-2 break_2 hir pr-2">
      ...
      <div className="flex">
        <div className="border bottom heart flex-2">
          ...
          <div className="content py-1" >
            ...
            <div className="time">{Date().toString().slice(0, 25)}</div>
          </div>
        </div>
