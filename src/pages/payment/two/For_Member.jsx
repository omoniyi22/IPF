...
class AdditionalMember extends Component {
  constructor(props) {
    super(props)
    this.state = {
      name: "",
  ...
  render() {
    ...
    const annualFeesList = this.returnAnnualFeesList(fee_list, "MEMBERSHIP") || []
    return (
                    ...
                    <>
                      {
                        list_failed === true ?
                          ...
                          <>
                            ...
                            {annualFeesList.map(fi => <option >{fi.name}</option>)}
                          </>
                      }
                    </>
                }
...
export default withRouter(AdditionalMember)