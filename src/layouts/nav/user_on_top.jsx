          ...
          <div className="user_on_top">
            ...
            <div className="user_brief   flex">
              <div className="brief  ml-auto">
                <div className="user_pix z-depth-2  rounded-pill p-4 ml-auto sm-hide my-auto" style={{ backgroundImage: `url(${require('./../../assets/medias/user.png')})` }} />
                ...
                <div className="user_pix z-depth-2   rounded-pill p-4 sm-show" style={{ backgroundImage: `url(${require('./../../assets/medias/user.png')})` }} />
              </div>
