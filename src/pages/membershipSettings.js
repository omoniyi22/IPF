...
class MembershipSettings extends Component {
  ...
  getPageAccountSettings = async () => {
    try {
      ...
      const response1 = await Axios.get("/api/v1/admin/membership-type", {
        headers: { "x-access-token": token },
      });
      const response2 = await Axios.get("/api/v1/admin/industry-type", {
        headers: { "x-access-token": token },
      });
      const response3 = await Axios.get(
        "/api/v1/admin/industry-classification",
        { headers: { "x-access-token": token } }
      );
          ...
          <div className="row">
                ...
                <MaterialTable
                  ...
                  editable={{
                    ...
                    onRowDelete: async (oldData) => {
                      ...
                      try {
                        // const token = localStorage.getItem('x-access-token');
                        await Axios.delete("/api/v1/admin/membership-type", {
                          id: `${oldData.id}`,
                        });
                        this.props.showLoader(false);
            ...
            <div className=" col-lg-6 mb-3 box col-sm-12">
              <div className="shadow h-100 bg-white p-3 ">
                ...
                <MaterialTable
                  title=""
                  columns={[{ title: "Industry Type", field: "industry_name" }]}
